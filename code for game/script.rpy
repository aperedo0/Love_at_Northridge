...
label start:
    ...
    "It's your second week of your last semester at school"
    scene school
    "Once at school you can't find your classes"
    "As you decide to walk around and ask someone for help"
    "You end up bumping into Ed."

    #show a Ed
    show ed happy
    E "Morning! Why do you look so lost?"
    #response
    P "Good morning I need to go to Jacaranda Hall and the Library"
    P "How do I get there?"

    E "I'll be glad to help guide you!"
    E "Which building would you like to visit first?"
    menu:
        #this first two choices are going to be yes and no, just so you can meet the characters
        "Library":
            jump library
        "Jacaranda hall":
            jump jacaranda_hall
...
label library:
    ...
    E "Simply go straight for about a minute and you're going to see a small staircase"
